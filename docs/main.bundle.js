...
var MainComponent = (function () {
    ...
    MainComponent.prototype.ngOnInit = function () {
        ...
        setInterval(function () {
            if (i == __WEBPACK_IMPORTED_MODULE_1_jquery__("#background").children().length - 1) {
                i = 0;
                __WEBPACK_IMPORTED_MODULE_1_jquery__("#background").children().css("display", "block");
            }
            __WEBPACK_IMPORTED_MODULE_1_jquery__(__WEBPACK_IMPORTED_MODULE_1_jquery__("#background").children()[i]).fadeOut(2000);
            i = i + 1;
        }, 10000);
    };
